...
np.savetxt("H.data", H.T.ravel(), delimiter=" ")
np.savetxt("F.data", F.T.ravel(), delimiter=" ")
np.savetxt("C.data", C.T.ravel(), delimiter=" ")
np.savetxt("S.data", S.T.ravel(), delimiter=" ")

print("E_electric is", E_electric)
print("E_nuclear is", mol.nuclear_repulsion_energy())
print("E_total is", E_total)
